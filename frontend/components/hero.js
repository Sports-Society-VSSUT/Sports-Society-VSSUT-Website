...
const Hero = () => {
  ...
  <div className={styles.main}>
   ...
   <div className={styles.about} id="about-us" >
    ...
    <p>Sports Society focuses on promoting and fostering sports among the students, faculty and staff of the university. The society aims to provide a platform for students to participate in a wide range of sports activities including both indoor and outdoor sports, and to develop and improve their physical and mental well-being.
    The Sports Society of VSSUT organizes various sports events, tournaments, and competitions throughout the year such as football, cricket, volleyball, badminton, and many more. Vssut also has sports clubs like VSSUT Cricket Club- VCC, VSSUT Shuttlers-VSS, VSSUT Basketball Club- VBC, VSSUT football club vfc, VSSUT Volleyball Club which provide a highly competitive environment where the talent of students is furnished and sharpened.</p>
    </div>
